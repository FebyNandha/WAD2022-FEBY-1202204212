      ...
      <div class="col">
        ...
        <input type="hidden" name="id_mobil" value="<?php echo $id_mobil; ?>">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" value="<?php echo $saved['nama_mobil'] ?>">
            </div>

            <div class="mb-3">
                <label for="nama" class="form-label"><strong>Nama Pemilik</strong></label><br>
                <input class="form-control" type="text" value="<?php echo $saved['pemilik_mobil'] ?>">
            </div>

            <div class="mb-3">
                <label for="merk" class="form-label"><strong>Merk</strong></label>
                <input class="form-control" type="text" value="<?php echo $saved['merk_mobil'] ?>">
            </div>

            <div class="mb-3">
                <label for="merk" class="form-label"><strong>Tanggal Beli</strong></label>
                <input class="form-control" type="text" value="<?php echo $saved['tanggal_beli'] ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" value="<?php echo $saved['foto_mobil'] ?>">
            </div>
