...
<body>
<?php 
    while($mobil = mysqli_fetch_array($row)){
        ...
        <div class="card" style="width:300px">
            ...
            <div class='card-body'>
                <div class='container'>
                    ...
                    <p class='card-text'> <?php echo substr($mobil['deskripsi'],0,50)."...";?> </p>
                    <a href='Detail-Feby.php?id=<?php echo $mobil['id_mobil'];?>' class='btn btn-primary'>Detail</a>
                    <a href='delete.php?id=<?php echo $mobil['id_mobil'];?>' class='btn btn-danger'>Delete</a>
                </div>
            </div>
        </div>
    </div>
